...
public class SweetDialogActivity extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView)findViewById(R.id.txtTitle)).setText("SweetDialog");
        findViewById(R.id.txtNext).setVisibility(View.INVISIBLE);
        findViewById(R.id.imageQuitActivity).setOnClickListener(this);
