...
public class MainActivity extends MyActivity implements OnItemClickListener, OnClickListener
{
	...
	protected void findView() {
		((TextView)findViewById(R.id.txtNext)).setText("呵呵");
		...
		listData.add(new ItemModel("摇一摇", SensorTestActivity.class));
		listData.add(new ItemModel("底部的Dialog", BottomDialogActivity.class));
